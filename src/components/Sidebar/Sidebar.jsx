  ...
  if (decodedToken == null || isExpired) {
    ...
    return (
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="flex flex-col h-full px-3 py-10 bg-white">
          ...
          <button
            ...
            className=" margin-top: auto w-full p-3 text-gray-900 hover:text-white rounded-lg hover:bg-custom-blue transition duration-75"
          >
            Cerrar sesión
          </button>
        </div>
